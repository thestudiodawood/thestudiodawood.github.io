...
$("#count").html("you lost");
	...
	if((n=="9a")&&(arr[0]==1))
	{
		arr[0]=-2;score+=50;alert("correct");
	}
	if((n=="9a")&&(arr[1]==1))
		{
		arr[1]=-2;score+=50;alert("correct");
	}
	if((n=="9a")&&(arr[2]==1))
		{
		arr[2]=-2;score+=50;alert("correct");
	}
	if((n=="9b")&&(arr[0]==2))
	{
		arr[0]=-2;score+=50;alert("correct");
...
{
 $("#count").html("you save doctor  score :"+score);
	var vid = document.getElementById("myVideo"); 
...
if((arr[0]==-2)&& (arr[1]==-2)&&(arr[2]==-2)&&(parseInt($('#count').html(), 10)>0))
{
 $("#count").html("you save doctor"+score); 
	var vid = document.getElementById("myVideo"); 
			vid.src="videos/win.mp4"; 
			 vid.play();  
}
